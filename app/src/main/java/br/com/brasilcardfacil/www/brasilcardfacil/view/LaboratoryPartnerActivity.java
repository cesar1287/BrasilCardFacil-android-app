...
public class LaboratoryPartnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laboratory_partner);
    ...
    public void loadList(){
        ...
        partner.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(LaboratoryPartnerActivity.this, "Algo deu errado ao carregar os parceiros, " +
        ...
        partner.addListenerForSingleValueEvent(new ValueEventListener() {
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(frag == null) {
                    ...
                    ft.replace(R.id.lab_fragment_container, frag, "mainFrag");
                    ft.commit();
                }
