...
public class ClinicHospitalPartnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clinic_hospital_partner);
    ...
    public void loadList(){
        ...
        partner.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(ClinicHospitalPartnerActivity.this, "Algo deu errado ao carregar os parceiros, " +
        ...
        partner.addListenerForSingleValueEvent(new ValueEventListener() {
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(frag == null) {
                    ...
                    ft.replace(R.id.clinic_fragment_container, frag, "mainFrag");
                    ft.commit();
                }
