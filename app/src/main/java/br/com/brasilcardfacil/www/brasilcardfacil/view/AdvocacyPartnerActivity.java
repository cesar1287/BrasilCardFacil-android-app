...
public class AdvocacyPartnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advocacy_partner);
    ...
    public void loadList(){
        ...
        valueEventListener = new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(AdvocacyPartnerActivity.this, "Algo deu errado ao carregar os parceiros, " +
        ...
        singleValueEventListener = new ValueEventListener() {
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(frag == null) {
                    ...
                    ft.replace(R.id.advocacy_fragment_container, frag, "mainFrag");
                    ft.commit();
                }
